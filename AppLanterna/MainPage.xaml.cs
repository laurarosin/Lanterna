...
namespace AppLanterna
{
    ...
    {           
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("AppLanterna.Image.botao-desligado.jpg");
        ...
        private async void BtnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (!lanterna_ligada)
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("AppLanterna.Image.botao-ligado.jpg");
